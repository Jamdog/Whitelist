...
class Main {
	...
	public $user;
	public $page;
	public $root = '/mumbo/'; //move to config
	function __construct() {
		$this->config = json_decode(file_get_contents('/home/apcorey/profiles/whitelistconfig.json'),true);
		...
		?>
			...
			<html>
				<head>
					...
					<link type="text/css" rel="stylesheet" href="<?=$this->root?>css/style.css">
					<link rel="stylesheet" href="<?=$this->root?>font-awesome/css/font-awesome.min.css">
					...
					<![endif]-->
					<script src="<?=$this->root?>js/menu.js" type="text/javascript"></script>
					<? if ($this->page['p'] == 'players') { echo '<script src="'.$this->root.'js/players.js" type="text/javascript"></script>'; } ?>
				</head>
				<body>
					<? $this->accountBar(); ?>
					<? $this->mainMenu(); ?>
	...
	public function mainMenu() {
		?>
			<nav>
				<ul>
					<li><a href='<?=$this->root?>players/'><i class="fa fa-user"></i> Players</a></li>
					<li><a href='<?=$this->root?>groups/'><i class="fa fa-users"></i> Groups</a></li>
				</ul>
			</nav>
		<?
	}
		...
		?>
			<div class='page'>
				<div class='playersMenu'>
					<ul style='clearfix'>
						<li class='addUser'><a href='<?=$this->root?>addplayer/'>Add User</a></li>
