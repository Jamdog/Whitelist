<?php
	...
	//Make sure to turn on rcon in the server.properties, here's how
	//enable-rcon = true
	//rcon.password = pass
	//rcon.port = port you want to talk to rcon through
	...
	class srcds_rcon {
		...
		public function rcon_command($command) {
			$requestId = 1;
			$s2 = '';
			...
			$data = pack("VV", $requestId, SERVERDATA_AUTH).$this->password.chr(0).$s2.chr(0);
